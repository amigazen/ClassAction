...
/* Programmheader
 ...
 1.11  01.11.99 : added SFS keyword
 1.12  07.12.99 : added NOKILLPART keyword
 1.13  17.12.99 : added VERBOSE mode
 1.14  14.01.00 : added DARC, ENTRY, DIMG
 1.15  12.02.00 : added auto DIMG and pattern support
 1.16  05.03.00 : bug fixes
 1.17  19.03.00 : support for XADFIF_NOUNCRUNCHSIZE
 1.18  28.05.00 : added final report
 1.19  04.06.00 : added multi-filesystem support
 1.20  27.07.00 : fixed multi-filesystem support for empty fs parts
*/
...
ULONG start(void)
{
  ...
  if((dosbase = (struct DosLibrary *) OpenLibrary("dos.library", 37)))
  {
    ...
    OpenLibrary("xadmaster.library", 7)))
    {
      struct Args args;
      struct RDArgs *rda;
	  ...
	  {
            ULONG numfile = 0, numdir = 0, numerr = 0;
	    struct xadArchiveInfo *ai;
            struct TagItem ti[5];
            struct TagItem ti2[4];
            LONG loop = 2;
	    ...
	    ti2[1].ti_Data = TRUE;
	    ti2[2].ti_Tag = TAG_DONE;
	    ti2[3].ti_Tag = TAG_DONE; /* needed later for loop */
		...
		ti2[0].ti_Data = (ULONG) ti;
		  ...
		  args.verbose ? "Info           " : "",args.showprot ? "Protection       " : "");
		    ...
		    {
	              Printf("<nosize> %8ld       %02ld.%02ld.%04ld %02ld:%02ld:%02ld ",
		  ...
		  /* Note! The hook may change the filename!!! */
	        ...
	        ti2[2].ti_Tag = XAD_STARTCLIENT;
	        ti2[2].ti_Data = (ULONG) ai->xai_Client->xc_Next;
	        xadFreeInfo(ai);
	        if(--loop)
	        {
	          loop = 0;
